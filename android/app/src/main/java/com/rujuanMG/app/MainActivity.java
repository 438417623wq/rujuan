...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_START_PATH = "com.rujuanMG.app.EXTRA_START_PATH";
    ...
    private void configureWebView() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " RujuanMG-Android/1.0");
